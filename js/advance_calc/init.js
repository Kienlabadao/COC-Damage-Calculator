...
const isRageSpellTowerActiveKey = "isRageSpellTowerActive";
...
let isRageSpellTowerActive = LocalStorageUtils.loadBoolean(isRageSpellTowerActiveKey, false);
...
document.addEventListener('init', () => {
  ...
  console.log(equipmentDivs);
  console.log(troopDivs);
  console.log(repairDivs);
  console.log(modifierDivs);
