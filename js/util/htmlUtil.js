class HTMLUtil {
  ...
  static createModifierOverlay(
    imagePath,
    overlayType = HTMLUtil.OVERLAY_NORMAL,
    modifierType
  ) {
    const modifierOverlay = document.createElement("div");
    modifierOverlay.className =
      "modifier overlay overlay--top-left overlay__img";
  ...
  static createLevelOverlay(object, overlayType = HTMLUtil.OVERLAY_NORMAL) {
    if (
      object instanceof Defense ||
      object instanceof Offense ||
      object instanceof Modifier
    ) {
      const levelOverlay = document.createElement("div");
      levelOverlay.className =
        "modifier overlay overlay--bottom-left overlay__number";
  ...
  static createSpellCountOverlay(spellCount) {
    if (NumberUtil.isNumber(spellCount)) {
      ...
      spellCountOverlay.className =
        "spell-count overlay overlay__number overlay__number--spell-count";
  ...
  static createOrderOverlay(
    orderNumber,
    overlayType = HTMLUtil.OVERLAY_NORMAL
  ) {
    const orderOverlay = document.createElement("div");
    orderOverlay.className =
      "modifier overlay overlay--top-right overlay__number overlay__number--order";
