...
export const EquipmentData: Record<string, EquipmentStats> = {
  ...
  snake_bracelet: {
    ...
    dps_boost: [
      { level: 1, dps_boost: 10 },
      { level: 2, dps_boost: 11 },
      { level: 3, dps_boost: 12 },
      { level: 4, dps_boost: 14 },
      { level: 5, dps_boost: 16 },
      { level: 6, dps_boost: 18 },
      { level: 7, dps_boost: 20 },
      { level: 8, dps_boost: 22 },
      { level: 9, dps_boost: 24 },
      { level: 10, dps_boost: 26 },
      { level: 11, dps_boost: 28 },
      { level: 12, dps_boost: 30 },
      { level: 13, dps_boost: 33 },
      { level: 14, dps_boost: 36 },
      { level: 15, dps_boost: 39 },
      { level: 16, dps_boost: 42 },
      { level: 17, dps_boost: 45 },
      { level: 18, dps_boost: 48 },
      { level: 19, dps_boost: 51 },
      { level: 20, dps_boost: 54 },
      { level: 21, dps_boost: 57 },
      { level: 22, dps_boost: 60 },
      { level: 23, dps_boost: 63 },
      { level: 24, dps_boost: 66 },
      { level: 25, dps_boost: 69 },
      { level: 26, dps_boost: 72 },
      { level: 27, dps_boost: 75 },
    ],
    atk_speed_boost: [],
    ability_boost: null,
  },
