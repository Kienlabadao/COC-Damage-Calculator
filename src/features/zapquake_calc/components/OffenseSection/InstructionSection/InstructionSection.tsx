      ...
      <CollapseContainer id={"show_instruction"}>
        ...
        <ul>
            ...
            <ul>
              ...
              <li>
                <div>
                  ...
                  you can select which one will be used first. This is important
                  because earthquake type damage deal less damage the more its
                  target get hit by it.
                </div>
                <ul>
                  <li>
          ...
          <li>
            ...
            <ul>
              <li>Navigate to the Defense List section to see the results.</li>
              <li>Select the appropriate defense level based on your needs.</li>
        ...
        <ul>
          ...
          <li>
            ...
            recommended to use a larger screen, such as a monitor or tablet, for
            the best experience.
          </li>
        </ul>
      </CollapseContainer>
