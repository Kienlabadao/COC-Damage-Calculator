...
export function Navbar() {
  ...
  const isCalculatorActive =
    location.pathname === `${PAGE_URLS.ZapquakeCalcPage}` ||
    location.pathname === `${PAGE_URLS.AdvanceCalcPage}`;
